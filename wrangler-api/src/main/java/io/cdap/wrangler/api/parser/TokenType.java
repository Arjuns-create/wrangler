...
public enum TokenType implements Serializable {
  ...
  /**
   * Represents the enumerated type for byte size values (e.g., "10KB", "1.5MB").
   * This type is associated with numeric values followed by byte units.
   */
  BYTE_SIZE,

  /**
   * Represents the enumerated type for time duration values (e.g., "100ms", "5s", "2h").
   * This type is associated with numeric values followed by time units.
   */
  TIME_DURATION
}
